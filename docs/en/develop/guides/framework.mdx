...
<CardGroup cols={2}>
    <Card title="Environment Variables" icon="square-1" href="/docs/en/develop/guides/environment-variables">
        Manage secrets with environment variables
    </Card>
    <Card title="Connect to DB/SaaS" icon="square-2" href="/docs/en/develop/guides/integration">
        Build a data app that accesses DB and SaaS
    </Card>
    <Card title="Use Variables" icon="square-3" href="/docs/en/develop/guides/variables">
        Customize the behavior of the data app according to user input
    </Card>
    <Card title="Role Based Access Control" icon="square-4" href="/docs/en/develop/guides/user-role">
