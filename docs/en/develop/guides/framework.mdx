...
To check the functions and features available in SQL and Python, see [Framework Reference](/reference/ja/framework/morph-project).
For details on MDX components available for frontend development, see [Component Reference](/data-application/ja/data-component-table).

When you are ready to share with your team, see [Deploy Guide](/docs/ja/deploy/dashboard-setup).

<CardGroup cols={2}>
    <Card title="Environment Variables" icon="square-1" href="/docs/ja/develop/guides/environment-variables">
        Manage secrets with environment variables
    </Card>
    <Card title="Connect to DB/SaaS" icon="square-2" href="/docs/ja/develop/guides/integration">
        Build a data app that accesses DB and SaaS
    </Card>
    <Card title="Use Variables" icon="square-3" href="/docs/ja/develop/guides/variables">
        Customize the behavior of the data app according to user input
    </Card>
    <Card title="Role Based Access Control" icon="square-4" href="/docs/ja/develop/guides/user-role">
