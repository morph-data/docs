...
<AccordionGroup>
  <Accordion title="Python 3.9 or higher" icon='python'>
    For the Morph framework to work, **Python 3.9 or higher is required**.
  ...
  <Accordion title="Node.js 18 or higher" icon='node-js'>
    For the Morph framework to function, **Node.js 18 or higher is required**.
  ...
  <Accordion title="Docker" icon="docker">
    Docker is required **to deploy the Morph framework in a cloud environment**.
