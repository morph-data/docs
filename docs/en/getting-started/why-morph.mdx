...
Data applications created locally can be deployed to the cloud with a single `morph deploy` command. User authentication and access restrictions are automatically set, allowing anyone to share applications securely.
