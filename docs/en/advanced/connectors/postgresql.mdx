  ...
  <Tab title="Cloud Version">
    <Steps>
      ...
      <Step title="Enter PostgreSQL Credentials">
        ...
        <img src="/assets/images/docs/advanced/connectors/connect-data-platform-postgresql-create.png" alt="PostgreSQL Connection Create" />
      ...
      <Step title="Connect to the Created Database">
        ...
        <img src="/assets/images/docs/advanced/connectors/connect-data-platform-postgresql-complete.png" alt="PostgreSQL Connection Create Complete" />
