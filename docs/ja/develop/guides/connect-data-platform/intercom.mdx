...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Intercomの認証情報を入力する">        
        Intercomを選択しサインインボタンを押下します。

        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-intercom-create.png" alt="Intercom Connection Create" />
  ...
  <Tab title="ローカル版">
    ...
    <Steps>
      <Step title="connections.ymlを編集する">
        ...
        ```yaml
        connections:
          intercom-connection: # 一意な任意の名前
            type: intercom
            method: intercom_oauth
            refresh_token: str
            client_id: str
            client_secret: str
            redirect_uri: str
