  ...
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Redshiftの認証情報を入力する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-redshift-create.png" alt="Redshift Connection Create" />
      ...
      <Step title="作成したデータベースに接続する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-redshift-complete.png" alt="Redshift Connection Create Complete" />
