...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Notionの認証情報を入力する">        
        Notionを選択しサインインボタンを押下します。

        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-notion-create.png" alt="Notion Connection Create" />
