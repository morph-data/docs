...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="BigQueryの認証情報を入力する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-bigquery-sa-create.png" alt="BigQuery Service Account Connection Create" />
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-bigquery-oauth-create.png" alt="BigQuery OAuth Connection Create" />
      ...
      <Step title="作成したデータベースに接続する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-bigquery-complete.png" alt="Snowflake Connection Create Complete" />
  ...
  <Tab title="ローカル版">
    <Info>ローカル版では現在Service Account方式のみがコマンドで作成可能です。それ以外の方式はクラウド版をご利用いただくか、直接~/.morph/connections.ymlに記述する必要があります。</Info>
