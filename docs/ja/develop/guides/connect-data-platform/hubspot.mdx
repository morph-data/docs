...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="HubSpotの認証情報を入力する">        
        HubSpotを選択しサインインボタンを押下します。

        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-hubspot-create.png" alt="HubSpot Connection Create" />
  ...
  <Tab title="ローカル版">
    ...
    <Steps>
      <Step title="connections.ymlを編集する">
        ...
        ```yaml
        connections:
          hubspot-connection: # 一意な任意の名前
            type: hubspot
            method: hubspot_oauth
            refresh_token: str
            client_id: str
            client_secret: str
            redirect_uri: str
