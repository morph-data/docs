...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Snowflakeの認証情報を入力する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-snowflake-kp-create.png" alt="Snowflake Key Pair Connection Create" />
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-snowflake-ip-create.png" alt="Snowflake ID Password Connection Create" />
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-snowflake-oauth-create.png" alt="Snowflake OAuth Connection Create" />
      ...
      <Step title="作成したデータベースに接続する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-snowflake-complete.png" alt="Snowflake Connection Create Complete" />
  ...
  <Tab title="ローカル版">
    <Info>ローカル版では現在User/Password方式のみがコマンドで作成可能です。それ以外の方式はクラウド版をご利用いただくか、直接~/.morph/connections.ymlに記述する必要があります。</Info>
