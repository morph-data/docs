  ...
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Mailchimpの認証情報を入力する">        
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-mailchimp-create.png" alt="Mailchimp Connection Create" />
