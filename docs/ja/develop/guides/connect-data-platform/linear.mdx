...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Linearの認証情報を入力する">        
        Linearを選択しサインインボタンを押下します。

        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-linear-create.png" alt="Linear Connection Create" />
