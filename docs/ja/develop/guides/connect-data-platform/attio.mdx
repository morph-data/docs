...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Attioの認証情報を入力する">        
        Attioを選択しサインインボタンを押下します。

        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-attio-create.png" alt="Attio Connection Create" />
