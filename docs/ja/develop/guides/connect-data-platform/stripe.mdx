...
<Tabs>
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Stripeの認証情報を入力する">        
        Stripeを選択しサインインボタンを押下します。

        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-stripe-create.png" alt="Stripe Connection Create" />
