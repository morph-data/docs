  ...
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="MySQLの認証情報を入力する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-postgresql-create.png" alt="MySQL Connection Create" />
      ...
      <Step title="作成したデータベースに接続する">
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-mysql-complete.png" alt="MySQL Connection Create Complete" />
