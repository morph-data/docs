  ...
  <Tab title="クラウド版">
    <Steps>
      ...
      <Step title="Airtableの認証情報を入力する">        
        ...
        <img src="/assets/images/docs/develop/guides/connect-data-platform/connect-data-platform-airtable-create.png" alt="Airtable Connection Create" />
