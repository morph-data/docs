...
<Steps>
  ...
  <Step title="パッケージをインストールする">
    ...
    ```bash
    pip install langchain langhchain-openai
    ```
  </Step>
...
<Frame>
  <video
    ...
    src="//videos.ctfassets.net/9ncizv60xc5y/2iLVmcZEi4k42qycBRtKKi/1b8ec7ab402f0aaaaf6c07ab2cd37967/Tutorial_AI_App.mp4"
  ></video>
</Frame>
